...
var runtimeRequire =  true ? eval("require") : undefined // eslint-disable-line
...
exports.ensureUTF8 = exports.readFile = void 0;
const core = __importStar(__webpack_require__(186));
const utf_8_validate_1 = __importDefault(__webpack_require__(161));
...
function ensureUTF8(buffer, fileName = null) {
    if (buffer.byteLength >= 3) {
        const slice = buffer.slice(0, 3);
        if (slice.compare(utf8Bom) === 0) {
            throw new Error(`Sorry, your file ${fileName} contains UTF-8 BOM, which is completely unnecessary.`);
        }
    }
    if (!utf_8_validate_1.default(buffer)) {
        throw new Error(`Sorry, your file ${fileName} is not a valid UTF-8 file`);
    }
}
exports.ensureUTF8 = ensureUTF8;
...
function lsFiles() {
    return child_process_1.execSync("git grep --cached -Il ''", Object({ encoding: "utf-8" })).split("\n");
}
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
try {
  module.exports = __webpack_require__(90)(__dirname);
} catch (e) {
